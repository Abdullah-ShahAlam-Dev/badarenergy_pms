...
class WorkOrderRejected extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return $build
            ->subject('Work Order ' . $this->workOrder->wo_number . ' Rejected - ' . config('app.name'))
            ->markdown('mail.email', [
                'url'            => $url,
                'content'        => 'Your Work Order <strong>' . $this->workOrder->wo_number . '</strong> has been <strong>rejected</strong>. Please review the remarks and duplicate or revise as needed.',
