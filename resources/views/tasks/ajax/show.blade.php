            ...
            <div class="card bg-white border-0 b-shadow-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <x-cards.data-row :label="__('Doc SNo#')" :value="$task->doc_sno ?? '--'" />
                        <x-cards.data-row :label="__('Annex A')" :value="$task->annex_a ?? '--'" />
                        <x-cards.data-row :label="__('Mode')" :value="$task->mode ?? '--'" />
                        <x-cards.data-row :label="__('Days')" :value="$task->days ?? '--'" />
                        <x-cards.data-row :label="__('UOM')" :value="$task->uom ?? '--'" />
                        <x-cards.data-row :label="__('Qty')" :value="$task->qty ?? '--'" />
