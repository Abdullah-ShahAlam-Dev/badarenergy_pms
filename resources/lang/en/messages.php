...
return array(
    ...
    'leadClientChangeSuccess' => 'Lead changed to dealer successfully.',
    ...
    'noClientAddedToProject' => 'No dealer assigned to the project.',
    ...
    'clientFinanceCount' => 'This dealer has :projectCount :project, :invoiceCount :invoice, :estimateCount :estimate, :paymentCount :payment . ',
    'signatureAdded' => 'Signature Added Successfully',
    'endTimeAfterOrEqual'=> 'The end time must be a time after or equal to start time.',
    ...
    'clientFilterVerification' => 'Dealer filter according verification',
    'welcome' => array(
    ...
    'smtpSecureEnabled' => 'For Gmail SMTP configuration, please follow the follow link ',
    'smtpNotSet' => 'You have not configured SMTP settings. You might get an error when adding info ',
    'addStripeWebhookUrlHelpVisit1' => 'Visit <a href="https://dashboard.stripe.com/account/webhooks" target="_blank">Generate</a> Add end point as above url and enter the webhook key generated',
    ...
    'noClientFound' => 'Seems like no dealer exists. Please create the dealer first',
    ...
    'signupSuccess' => 'Sign up successfully. You will be redirected to your dashboard in while',
    ...
    'assignClientFirst' => 'You need to assign a dealer to the project.',
    ...
    'selectCustomerForBillingAddress' => 'Select dealer to show billing address.',
    ...
    'proposalInfo' => 'Proposals are for Leads. If you want to create for existing dealers, then create Estimate.',
    ...
    'leaveFileMessage' => 'You can attach the receipt of prescription, doctor visit or travel document etc',
    ...
    'notAllowedToDeleteCurrency' => 'You are not allowed to delete this currency as its been used in other places.',
    'appNameToolTip' => 'This will be visible to left sidebar top and on login page',
    ...
    'configureCurrencyConverterKey' => 'You need to configure Currency converter key first to fetch Latest exchange rate. :link to add key',
    ...
    'googleMapRemove' => 'Leave blank to remove Google map key',
    'googleMapTooltip' => 'You can add the location on map in <b>:route</b> once google map setting is configured',
    ...
    'companyNameTooltip' => 'Add full name of your company. Company name visible to the left sidebar will be changed from theme setting',
    ...
    'pusherError' => 'Your Pusher details are not correct. Please update to correct one',
    'pusherSuccess' => 'Your Pusher details are correct',
    'authorisedSignatorySignatureTooltip' => 'This signature will appear on the paid invoices (only .jpg, .jpeg, .png formats are allowed). Check Show Authorised Signatory from bottom of the invoice setting page',
    'invoiceStatusShowTooltip' => 'This will show the invoice status (paid/unpaid/partial paid) on the invoice pdf',
    'invoiceAuthorisedSignatoryShowTooltip' => 'This will show the authorised signatory on the invoice pdf if Signature is uploaded and invoice status is paid.',
    ...
    'markSentInfo' => 'Dealer will not receive any email.',
    'enableClientModule' => 'Enable Dealer Module to access this section.',
    'leave' => array(
