<div class="row">
    <div class="col-sm-12">
        <x-form id="update-daily-report-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group my-3">
                                    ...
                                    <div id="summary">{!! $report->summary !!}</div>
                                    <textarea name="summary" id="summary-text" class="d-none">{!! $report->summary !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group my-3">
                                    ...
                                    <div id="blockers">{!! $report->blockers !!}</div>
                                    <textarea name="blockers" id="blockers-text" class="d-none">{!! $report->blockers !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group my-3">
                                    ...
                                    <div id="next_plan">{!! $report->next_plan !!}</div>
                                    <textarea name="next_plan" id="next_plan-text" class="d-none">{!! $report->next_plan !!}</textarea>
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <x-forms.file-multiple fieldLabel="Add More Attachments" fieldName="file" fieldId="daily-report-file-upload-dropzone" />
                ...
                <x-form-actions>
                    <x-forms.button-primary id="update-report-btn" class="mr-3" icon="check">
                        Update Report
...
<script>
    $(document).ready(function() {
        var $body = $('body');
        var drNamespace = '.dailyReportEdit';
        ...
        $body.on('click' + drNamespace, '#update-report-btn', function () {
            ...
            var url = "{{ route('daily-reports.update', $report->id) }}";

            $.easyAjax({
                url: url,
                container: '#update-daily-report-data-form',
                type: 'POST',
                disableButton: true,
                blockUI: true,
                buttonSelector: '#update-report-btn',
                data: $('#update-daily-report-data-form').serialize(),
