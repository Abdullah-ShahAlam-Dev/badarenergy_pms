...
class ProductSalesDataTable extends BaseDataTable
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('formatted_avg_price', function ($row) {
                return currency_format($row->avg_price);
            })
    ...
    public function query(InvoiceItems $model)
    {
        ...
        // Standard filter criteria applied to invoice parameters
        ...
        $query->groupBy('invoice_items.product_id', 'products.name', 'products.product_code');
    ...
    {
        return $this->builder()
            ->setTableId('product-sales-table')
            ...
            ->parameters([
                'initComplete' => 'function () {
                    window.LaravelDataTables["product-sales-table"].buttons().container()
    ...
    protected function getColumns()
    {
        return [
            ...
            'product' => ['data' => 'product', 'name' => 'products.name', 'title' => 'Product Name'],
            'product_code' => ['data' => 'product_code', 'name' => 'products.product_code', 'title' => 'Product Code'],
            'qty_sold' => ['data' => 'qty_sold', 'name' => 'qty_sold', 'title' => 'Quantity Sold', 'searchable' => false],
            'formatted_avg_price' => ['data' => 'formatted_avg_price', 'name' => 'avg_price', 'title' => 'Average Selling Price', 'searchable' => false],
