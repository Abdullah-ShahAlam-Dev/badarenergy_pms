...
<!-- NAV ITEM - CUSTOMERS COLLAPASE MENU -->
    ...
    @if (!in_array('client', user_roles()) && in_array('clients', user_modules()) && user()->permission('view_clients') != 'none')
...
<!-- NAV ITEM - PRODUCTS -->
    @if (in_array('products', user_modules()) && user()->permission('view_product') != 'none')
...
<!-- NAV ITEM - PRODUCTS -->
    @if (in_array('orders', user_modules()) && user()->permission('view_order') != 'none')
        <x-menu-item icon="cart3" text="Sales Orders" :link="route('orders.index')">
            <x-slot name="iconPath">
                <path
