...
return array (
    'dashboard' => array (
        'totalClients' => 'Total Dealers',
        'newClients' => 'New Dealers',
        ...
        'totalConvertedClient' => 'Total Dealer Convert',
        ...
        'earningsByClient' => 'Earnings By Dealer',
    ...
    'client' => array (
        ...
        'visibleToClient' => 'Visible To Dealer',
        'askToReenterPassword' => 'Ask to re-enter password',
        'createTitle' => 'Add Dealer Info',
        'companyDetails' => 'Company Details',
        'companyName' => 'Company Name',
        'website' => 'Official Website',
        'address' => 'Address',
        'clientDetails' => 'Dealer Details',
        'clientBasicDetails' => 'Dealer Basic Details',
        'clientOtherDetails' => 'Other Details',
        'clientName' => 'Dealer Name',
        'clientEmail' => 'Dealer Email',
        'clientPhone' => 'Dealer Phone',
        'emailNote' => 'Dealer will login using this email and email notifications will be sent to this email.',
        'password' => 'Password',
        'passwordNote' => 'Dealer will login using this password.',
        'passwordUpdateNote' => 'Leave blank to keep current password.',
        'mobile' => 'Mobile',
        'updateTitle' => 'Update Dealer Info',
        'addNewClient' => 'Add New Dealer',
        ...
        'sendCredentialsMessage' => 'Do you want to send credentials via E-mail to dealer ?',
        'assignProject' => 'Assign Project',
        'cell' => 'Cell',
        'officePhoneNumber' => 'Office Phone Number',
        'addedOn' => 'Added On',
        'clientCategory' => 'Dealer Category',
        'clientSubCategory' => 'Dealer Sub Category',
    ...
    'projects' => array (
        ...
        'clientViewTask' => 'Dealer can manage tasks of this project',
        'manualTimelog' => 'Allow manual time logs',
        'clientTaskNotification' => 'Send task notification to dealer',
        ...
        'clientMiroAccess' => 'Dealer Can Access Miro ',
        'projectClient' => 'Project Dealer Details ',
        'projectDoNotHaveClient' => 'This project do not contain any dealer',
    ...
    'tasks' => array (
        ...
        'sectionVisibleClient' => 'Section Visible To Dealer',
    ...
    'accountSettings' => array (
        ...
        'allowClientSignup' => 'Allow Dealer Signup',
        'allowClientSignupPopUp' => 'Allowing it will show the sign up button on login page for the dealers to get themselves register',
        'needClientSignupApprovalPopUp' => 'If you want newly registered dealer should be logged in to system only after it gets approved by the admin then enable this. Disabling it means the dealer can login without approval',
        'needClientSignupApproval' => 'Need admin approval after dealer signup',
        ...
        'appLanguageInfo' => 'This will be the default language of the application for every user. This can be changed by user in profile settings.',
    ...
    'moduleSettings' => array (
        ...
        'clientModuleTitle' => 'Dealer Module Title',
        'employeeSubTitle' => 'Select the modules which you want to enable.',
        'clientSubTitle' => 'Select the modules which dealer can access.',
    ...
    'messages' => array (
        ...
        'allowClientEmployeeChat' => 'Allow chat between dealer and employees?',
        'allowClientAdminChat' => 'Allow chat between dealer and admin?',
        'admins' => 'Administrators',
        'members' => 'Project Members',
        'typing' => 'typing',
        'allowClientProjectEmployeeChat' => 'Only project members can chat with dealer',
    ...
    'themeSettings' => array (
        ...
        'clientPanelTheme' => 'Dealer Panel Theme',
    ...
    'expensesRecurring' => array (
        ...
        'expenseGenerated' => 'The expense will be generate',
    ...
    'invoiceSettings' => array (
        ...
        'syncType' => 'Sync Type',
        'syncTypeInfo' => '<strong>One Way Sync:</strong> If you create invoice in this app then an invoice will be created on Quickbooks also.<br><br><strong>Two Way Sync:</strong> If you create invoice in this app then an invoice will be created on Quickbooks. And when invoice is created on Quickbooks then an invoice will be created in this app.',
        ...
        'syncInfo' => 'It is only One-Way Sync. If you create invoice or payment here then an invoice or payment will be created on Quickbooks too.',
    ...
    'lead' => array (
        ...
        'leadForm' => 'Lead Form',
        'iframeSnippet' => 'Copy & Paste the code anywhere in your site to show the form, additionally you can adjust the width and height px to fit for your website.',
    ...
    'contracts' => array (
        ...
        'setZero' => 'Set value to 0 if contract does not have cost.',
    ),
    'burndown' => array (
        'actual' => 'Actual',
        'ideal' => 'Ideal',
    ...
    'warehouse' => array(
        ...
        'typeTransit'              => 'Transit',
        'atLeastOneActiveError'    => 'At least one active warehouse must exist at all times.',
        'cannotDeleteActive'       => 'Cannot delete the last active warehouse.',
    ...
    'inventory' => array(
        ...
        'remarksPlaceholder' => 'Reason for stock adjustment (e.g. damaged stock, count update)...',
        'adjustedQty' => 'Adjusted Quantity',
        'manualAdjustment' => 'Manual Stock Adjustment',
        'addStock' => 'Add Stock (In)',
        'removeStock' => 'Remove Stock (Out)',
        'negativeStockError' => 'Negative stock is not allowed.',
    ),
);
