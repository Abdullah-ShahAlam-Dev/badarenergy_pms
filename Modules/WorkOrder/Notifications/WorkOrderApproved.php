...
class WorkOrderApproved extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return $build
            ->subject('Work Order ' . $this->workOrder->wo_number . ' Approved - ' . config('app.name'))
            ->markdown('mail.email', [
                'url'            => $url,
                'content'        => 'Your Work Order <strong>' . $this->workOrder->wo_number . '</strong> has been <strong>approved</strong>.',
