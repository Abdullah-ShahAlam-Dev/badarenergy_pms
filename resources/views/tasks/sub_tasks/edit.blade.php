        ...
        <div class="row">
            ...
            <div class="col-md-4">
                @php
                    ...
                    $canAssignToOthers = in_array('admin', user_roles()) || $assignSubTaskPermission == 'all';
                @endphp
                ...
                @else
                    <!-- Junior Employees cannot re-assign. Maintain existing assignment. -->
                    <input type="hidden" name="user_id" value="{{ $subTask->assigned_to }}">
                @endif
            </div>
            <div class="col-md-12">
