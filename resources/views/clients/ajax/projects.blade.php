...
<script>
    (function() {
        ...
        var showTable = function() {
            if (window.LaravelDataTables["projects-table"]) {
        ...
        $body.on('change.clientsProjects', '#quick-action-type', function() {
        ...
        $body.on('click.clientsProjects', '#quick-action-apply', function() {
        ...
        $body.on('click.clientsProjects', '.delete-table-row', function() {
        ...
        $body.on('click.clientsProjects', '.archive', function() {
            var id = $(this).data('user-id');
            Swal.fire({
                title: "@lang('messages.sweetAlertTitle')",
