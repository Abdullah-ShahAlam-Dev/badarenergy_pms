...
@push('scripts')
    ...
    <script>
        (function() {
            var $body = $('body');
            var namespace = '.attendanceIndex';

            $body.off(namespace);

            $body.on('change' + namespace, '#user_id, #department, #designation, #month, #year', function() {
            ...
            function addAttendance(userID) {
                ...
                let dayTime = attendanceDate[2].split(' ');
                let day = dayTime[0];
