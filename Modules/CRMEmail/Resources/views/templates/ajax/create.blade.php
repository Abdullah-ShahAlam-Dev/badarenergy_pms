...
<script>
    $(document).ready(function() {
        ...
        $('#save-template-btn').click(function() {
            ...
            const url = "{{ route('crm-email-templates.store') }}";
