<div class="row">
    <div class="col-sm-12">
        <x-form id="save-segment-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-9 border-right-grey">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <x-forms.text fieldId="name" fieldLabel="Segment Name" fieldName="name"
                                    fieldRequired="true" fieldPlaceholder="e.g. Inactive Clients in USA"
                                    :fieldValue="$segment->name"></x-forms.text>
                            </div>
                                ...
                                <div class="d-flex flex-wrap mt-1">
                                    <div class="custom-control custom-checkbox mr-4">
                                        <input type="checkbox" class="custom-control-input source-checkbox" id="source-clients" name="sources[]" value="clients"
                                            {{ in_array('clients', $segment->sources ?: []) ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-checkbox mr-4">
                                        <input type="checkbox" class="custom-control-input source-checkbox" id="source-leads" name="sources[]" value="leads"
                                            {{ in_array('leads', $segment->sources ?: []) ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input source-checkbox" id="source-contacts" name="sources[]" value="contacts"
                                            {{ in_array('contacts', $segment->sources ?: []) ? 'checked' : '' }}>
                        ...
                        @php
                            $clientCriteria = $segment->criteria['clients'] ?? [];
                        @endphp
                        <div class="card border-grey mb-4 bg-light filter-source-card" id="client-filters-card" style="display: none;">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[clients][status][]" id="client-status" multiple data-actions-box="true" data-container="body">
                                                <option value="active" {{ in_array('active', $clientCriteria['status'] ?? []) ? 'selected' : '' }}>Active</option>
                                                <option value="deactive" {{ in_array('deactive', $clientCriteria['status'] ?? []) ? 'selected' : '' }}>Deactive</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[clients][category_ids][]" id="client-category" multiple data-actions-box="true" data-live-search="true" data-container="body">
                                                @foreach($clientCategories as $cat)
                                                    <option value="{{ $cat->id }}" {{ in_array($cat->id, $clientCriteria['category_ids'] ?? []) ? 'selected' : '' }}>{{ $cat->category_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[clients][sub_category_ids][]" id="client-subcategory" multiple data-actions-box="true" data-live-search="true" data-container="body">
                                                @foreach($clientSubCategories as $subcat)
                                                    <option value="{{ $subcat->id }}" {{ in_array($subcat->id, $clientCriteria['sub_category_ids'] ?? []) ? 'selected' : '' }}>{{ $subcat->category_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[clients][country_ids][]" id="client-country" multiple data-actions-box="true" data-live-search="true" data-container="body">
                                                @foreach($countries as $country)
                                                    <option value="{{ $country->id }}" {{ in_array($country->id, $clientCriteria['country_ids'] ?? []) ? 'selected' : '' }}>{{ $country->nicename }} ({{ $country->iso }})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <!-- City -->
                                    <div class="col-md-4 mt-2">
                                        <x-forms.text fieldId="client-city" fieldLabel="City" fieldName="criteria[clients][city]" fieldPlaceholder="e.g. New York" :fieldValue="$clientCriteria['city'] ?? ''"></x-forms.text>
                                    </div>

                                    <!-- State -->
                                    <div class="col-md-4 mt-2">
                                        <x-forms.text fieldId="client-state" fieldLabel="State" fieldName="criteria[clients][state]" fieldPlaceholder="e.g. NY" :fieldValue="$clientCriteria['state'] ?? ''"></x-forms.text>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @php
                            $leadCriteria = $segment->criteria['leads'] ?? [];
                        @endphp
                        <div class="card border-grey mb-4 bg-light filter-source-card" id="lead-filters-card" style="display: none;">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                        ...
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[leads][status_ids][]" id="lead-status" multiple data-actions-box="true" data-live-search="true" data-container="body">
                                                @foreach($leadStatuses as $status)
                                                    <option value="{{ $status->id }}" {{ in_array($status->id, $leadCriteria['status_ids'] ?? []) ? 'selected' : '' }}>{{ $status->type }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[leads][source_ids][]" id="lead-source" multiple data-actions-box="true" data-live-search="true" data-container="body">
                                                @foreach($leadSources as $source)
                                                    <option value="{{ $source->id }}" {{ in_array($source->id, $leadCriteria['source_ids'] ?? []) ? 'selected' : '' }}>{{ $source->type }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[leads][category_ids][]" id="lead-category" multiple data-actions-box="true" data-live-search="true" data-container="body">
                                                @foreach($leadCategories as $cat)
                                                    <option value="{{ $cat->id }}" {{ in_array($cat->id, $leadCriteria['category_ids'] ?? []) ? 'selected' : '' }}>{{ $cat->category_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Country -->
                                    <div class="col-md-4 mt-2">
                                        <x-forms.text fieldId="lead-country" fieldLabel="Country" fieldName="criteria[leads][country]" fieldPlaceholder="e.g. United States" :fieldValue="$leadCriteria['country'] ?? ''"></x-forms.text>
                                    </div>

                                    <!-- City -->
                                    <div class="col-md-4 mt-2">
                                        <x-forms.text fieldId="lead-city" fieldLabel="City" fieldName="criteria[leads][city]" fieldPlaceholder="e.g. Los Angeles" :fieldValue="$leadCriteria['city'] ?? ''"></x-forms.text>
                                    </div>

                                    <!-- State -->
                                    <div class="col-md-4 mt-2">
                                        <x-forms.text fieldId="lead-state" fieldLabel="State" fieldName="criteria[leads][state]" fieldPlaceholder="e.g. California" :fieldValue="$leadCriteria['state'] ?? ''"></x-forms.text>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @php
                            $contactCriteria = $segment->criteria['contacts'] ?? [];
                        @endphp
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[contacts][parent_client_status][]" id="contact-parent-status" multiple data-actions-box="true" data-container="body">
                                                <option value="active" {{ in_array('active', $contactCriteria['parent_client_status'] ?? []) ? 'selected' : '' }}>Active</option>
                                                <option value="deactive" {{ in_array('deactive', $contactCriteria['parent_client_status'] ?? []) ? 'selected' : '' }}>Deactive</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group c-inv-select">
                                            ...
                                            <select class="form-control select-picker" name="criteria[contacts][designations][]" id="contact-designations" multiple data-actions-box="true" data-live-search="true" data-container="body">
                                                @foreach($designations as $desig)
                                                    <option value="{{ $desig }}" {{ in_array($desig, $contactCriteria['designations'] ?? []) ? 'selected' : '' }}>{{ $desig }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-segment-btn').click(function() {
            const url = "{{ route('crm-email-segments.update', $segment->id) }}";
        ...
        // Toggle on page load and trigger estimation
        toggleCards();
        $('#estimate-btn').click();
