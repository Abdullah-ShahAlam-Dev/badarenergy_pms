...
@if (in_array('crm_email', user_modules()) && ($viewPermission == 'all' || $viewPermission == 'added' || in_array('admin', user_roles())))
    <x-menu-item icon="envelope" :text="__('CRM Email')" :active="request()->routeIs('crm-email-templates.*') || request()->routeIs('crm-email-segments.*') || request()->routeIs('crm-email-campaigns.*')">
