...
<script>
    (function() {
        ...
        $body.on('change.clientsInvoices', '#quick-action-type', function() {
        ...
        $body.on('click.clientsInvoices', '#quick-action-apply', function() {
        ...
        $body.on('click.clientsInvoices', '.delete-table-row', function() {
        ...
        $body.on('click.clientsInvoices', '.sendButton', function() {
            var id = $(this).data('invoice-id');
        ...
        $body.on('click.clientsInvoices', '.reminderButton', function() {
            var id = $(this).data('invoice-id');
        ...
        $body.on('click.clientsInvoices', '.invoice-upload', function() {
            var invoiceId = $(this).data('invoice-id');
            var url = "{{ route('invoices.file_upload') }}?invoice_id=" + invoiceId;
            $.ajaxModal(MODAL_LG, url);
        });

        $body.on('click.clientsInvoices', '.unpaidAndPartialPaidCreditNote', function() {
            var id = $(this).data('invoice-id');
            Swal.fire({
        ...
        $body.on('click.clientsInvoices', '.cancel-invoice', function() {
            var id = $(this).data('invoice-id');
            Swal.fire({
                title: "@lang('messages.sweetAlertTitle')",
        ...
        $body.on('change.clientsInvoices keyup.clientsInvoices', '#search-text-field, #status', function() {
        ...
        $body.on('click.clientsInvoices', '#reset-filters', function() {
            $('#filter-form')[0].reset();
        ...
        $body.on('click.clientsInvoices', '.add-shipping-address', function() {
            var invoiceId = $(this).data('invoice-id');
            var url = "{{ route('invoices.shipping_address_modal', [':id']) }}".replace(':id', invoiceId);
            $.ajaxModal(MODAL_LG, url);
        });
