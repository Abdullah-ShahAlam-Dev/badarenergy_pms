            ...
            <div class="d-block d-lg-flex d-md-flex my-3">
                ...
                <div class="select-box py-2 px-0 mr-3">
                    ...
                    <select class="form-control select-picker" name="leave_year" id="leave_year">
                        @for ($i = now(company()->timezone)->subYears(2)->year; $i <= now(company()->timezone)->addYear()->year; $i++)
                            <option {{ now(company()->timezone)->year == $i ? 'selected' : '' }}>{{ $i }}
                            </option>
                        @endfor
                    </select>
                </div>
                ...
                <!-- RESET START -->
                <div class="select-box d-flex py-3 px-lg-2 px-md-2 px-0 mt-0 mt-lg-4 mt-md-4">
