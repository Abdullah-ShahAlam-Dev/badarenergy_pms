...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
        <div class="text-center mb-4">
            <img src="{{ optional($pwaSettings)->logo_url }}" alt="Logo" style="max-height: 50px;" class="mx-auto rounded">
        </div>


        <div class="text-center text-lg text-gray-500  tracking-wider pt-8">
            <div class="px-4 text-lg text-gray-500  border-gray-400 tracking-wider">
                401
            </div>

            <div class="ml-4 text-lg text-gray-500 uppercase tracking-wider">
                {{ __('messages.accessDenied') }}
            </div>

            <div class="border-l border-gray-400 pt-8">
                {{__('messages.accessDeniedMessage')}}
            </div>
